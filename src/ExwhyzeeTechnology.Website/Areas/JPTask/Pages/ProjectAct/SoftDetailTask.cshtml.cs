...
namespace ExwhyzeeTechnology.Website.Areas.JPTask.Pages.ProjectAct
{
    ...
    public class SoftDetailTaskModel : PageModel
    {
        ...
        public SoftDetailTaskModel(ExwhyzeeTechnology.Persistence.EF.SQL.DashboardDbContext context, UserManager<Profile> userManager, IEmailSendService email, LoggerLibrary logger)
        {
            _context = context;
