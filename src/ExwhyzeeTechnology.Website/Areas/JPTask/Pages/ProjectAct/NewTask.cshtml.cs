...
namespace ExwhyzeeTechnology.Website.Areas.JPTask.Pages.ProjectAct
{
    ...
    public class NewTaskModel : PageModel
    {
        ...
        public NewTaskModel(ExwhyzeeTechnology.Persistence.EF.SQL.DashboardDbContext context, IEmailSendService email, UserManager<Profile> userManager, LoggerLibrary logger)
        {
            _context = context;
            _email = email;
