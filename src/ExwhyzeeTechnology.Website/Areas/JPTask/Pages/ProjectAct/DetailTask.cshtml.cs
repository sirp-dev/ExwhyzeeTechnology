...
namespace ExwhyzeeTechnology.Website.Areas.JPTask.Pages.ProjectAct
{
    ...
    public class DetailTaskModel : PageModel
    {
        ...
        public DetailTaskModel(ExwhyzeeTechnology.Persistence.EF.SQL.DashboardDbContext context, UserManager<Profile> userManager, IEmailSendService email, LoggerLibrary logger)
        {
            _context = context;
