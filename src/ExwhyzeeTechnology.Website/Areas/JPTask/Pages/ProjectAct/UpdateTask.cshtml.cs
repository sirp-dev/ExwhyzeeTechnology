...
namespace ExwhyzeeTechnology.Website.Areas.JPTask.Pages.ProjectAct
{
    ...
    public class UpdateTaskModel : PageModel
    {
        ...
        public UpdateTaskModel(ExwhyzeeTechnology.Persistence.EF.SQL.DashboardDbContext context, IEmailSendService email, UserManager<Profile> userManager, LoggerLibrary logger)
        {
            _context = context;
            _email = email;
