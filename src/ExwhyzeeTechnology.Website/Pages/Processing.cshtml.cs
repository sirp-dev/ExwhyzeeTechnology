...
namespace ExwhyzeeTechnology.Website.Pages
{
    public class ProcessingModel : PageModel
    {
        ...
        public ProcessingModel(ExwhyzeeTechnology.Persistence.EF.SQL.DashboardDbContext context, ISettingsService settingsService, UserManager<Profile> userManager)
        {
            _context = context;
