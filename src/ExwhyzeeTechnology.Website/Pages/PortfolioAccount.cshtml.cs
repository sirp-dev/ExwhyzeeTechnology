...
namespace ExwhyzeeTechnology.Website.Pages
{
    public class PortfolioAccountModel : PageModel
    {
        ...
        public PortfolioAccountModel(ExwhyzeeTechnology.Persistence.EF.SQL.DashboardDbContext context, ISettingsService settingsService, UserManager<Profile> userManager)
        {
            _context = context;
